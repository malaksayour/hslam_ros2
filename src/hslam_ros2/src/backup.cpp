  ...
  private:
	...
	void initROSParams(){
		map_topic_=declare_parameter("mapTopic" ,"/map");
      	...
      	useSampleOutput_=declare_parameter("useSampleOutput" ,true);
      	loopClosure_=declare_parameter("loopClosure",false);
